...
/**
* The HA Server
* This server class is instantiated by the AsyncElection,
...
public class HAServer implements Runnable{
	...
	private static Logger logger = LoggerFactory.getLogger(HAServer.class);
	...
	/**
	 * Instantiate a HAServer object.
	 * The AsyncElection class will instantiate a server object, which will
	 * be provided with the port it should run on, the current state of the
	 * async election itself and the controllerID of this controller.
	 * 
	 * @param serverPort The port which it should run on.
	 * @param aelection Current running object of class AsyncElection
	 * @param controllerID Controller ID of this controller instance.
	 */
	...
	@Override
	public void run() {
			Integer lastfour = Integer.valueOf(this.serverPort.substring(10));
			...
			sb.group(serverbossPool,serverworkerPool)
	            ...
	            .childHandler(new ServerChannelInitializer (this.aelection, this.controllerID) );
