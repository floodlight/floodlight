...
public class SqlResultSet implements IResultSet {

	SQLStorageSource storageSource;
	String tableName;
	...
	SqlResultSet(SQLStorageSource storageSource, String tableName,
			List<Map<String, Object>> rowList) {
		...
		if (obj instanceof Short) {
			...
			try {
				...
				throw new TypeMismatchStorageException(Short.class.getName(),
						obj.getClass().getName(), columnName);
			}
		} else {
			s = null;
		}
	...
	public Integer getIntegerObject(String columnName) {
		...
		if (obj instanceof Integer) {
			...
			try {
				...
				throw new TypeMismatchStorageException(Integer.class.getName(),
						obj.getClass().getName(), columnName);
			}
		} else {
			i = null;
	...
	public Double getDoubleObject(String columnName) {
		...
		if (obj instanceof Double) {
			...
			try {
				...
				throw new TypeMismatchStorageException(Double.class.getName(),
						obj.getClass().getName(), columnName);
			}
		} else {
			d = null;
	...
	public Boolean getBooleanObject(String columnName) {
		...
		if (obj instanceof Boolean) {
			...
			try {
				...
				throw new TypeMismatchStorageException(Boolean.class.getName(),
						obj.getClass().getName(), columnName);
			}
		} else {
			b = null;
